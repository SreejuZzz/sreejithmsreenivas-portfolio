    ...
    <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden transition-colors duration-500 pt-16">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center space-y-8 animate-fade-in">
          {/* Profile Photo */}
          <div className="relative mx-auto w-32 h-32 sm:w-40 sm:h-40 md:w-48 md:h-48 mb-6 sm:mb-8 z-30">
            <div className="glass rounded-full p-1 sm:p-2 neumorphism relative z-30">
              <img
                src={profilePhoto}
                alt="Sreejith M S"
          ...
          <div className="space-y-6">
            <div className="space-y-2">
              ...
              <div className="text-lg sm:text-xl md:text-2xl text-primary font-semibold relative z-20 drop-shadow-lg">
                DevOps Engineer & Cloud Architect
              </div>
              <div className="text-base sm:text-lg text-muted-foreground relative z-20 drop-shadow-lg">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center pt-4 sm:pt-6 px-4 sm:px-0">
              <Button size="sm" className="bg-gradient-primary text-white hover:scale-105 transition-spring px-6 sm:px-8 w-full sm:w-auto sm:size-lg">
                <Mail className="mr-2 h-4 w-4 sm:h-5 sm:w-5" />
                Get In Touch
              </Button>
              <Button variant="outline" size="sm" className="glass hover:scale-105 transition-spring px-6 sm:px-8 w-full sm:w-auto sm:size-lg">
            ...
            {/* Social Links */}
            <div className="flex justify-center flex-wrap gap-3 sm:gap-4 pt-6 sm:pt-8 px-4 sm:px-0">
              <a
